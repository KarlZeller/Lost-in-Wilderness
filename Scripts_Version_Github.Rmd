...
gform_fr=read.csv(file=file.path("ggform_FR.csv"),header = F,sep=";")  #TEST
gform_de=read.csv(file=file.path("ggform_DE.csv"),header = F, sep=";")  
gform_es=read.csv(file=file.path("ggform_ES.csv"),header = F, sep=";")  
gform_en=read.csv(file=file.path("ggform_EN.csv"),header = F, sep=";")  
...
```{r}
Elo_fr=read.csv(file=choose.files(),header = T, sep=",")  
Elo_es=read.csv(file=choose.files(),header = T, sep=",")  
Elo_de=read.csv(file=choose.files(),header = T, sep=",")  
Elo_en=read.csv(file=choose.files(),header = T, sep=",")  
```
...
```{r}
Groups = read.csv(file=choose.files(),header = T, sep=";") 
Groups
```
